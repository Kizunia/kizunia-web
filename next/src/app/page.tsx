  ...
  return (
    <div className="w-screen mx-auto  h-screen overflow-hidden">
      ...
      >
        ...
        <Link href={"/competitions"}  className=" mt-6 bg-slate-800 no-underline group  relative shadow-2xl shadow-zinc-900 rounded-full p-px text-md font-semibold leading-6  text-white inline-block">
